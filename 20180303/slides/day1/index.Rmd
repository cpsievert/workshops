...
<iframe src="sf-us-ggplotly-tooltip.html" width="100%" height="550" scrolling="no" seamless="seamless" frameBorder="0"> </iframe>
...
<iframe src="sf-us-ggplotly-subplot.html" width="100%" height="550" scrolling="no" seamless="seamless" frameBorder="0"> </iframe>
...
<h2 align="center"> Let's work through the 'demo.R' script </h2>

The 'demo.R' file should be open in your source pane, but it resides under 'workshops' -> '20180303' -> 'slides' -> 'day1'
...
```{r, code=readLines("../../../20171118/slides/day1/03-heatmap.R")}
```

<iframe src="../../../20171118/slides/day1/03-heatmap.html" width="100%" height="400" scrolling="no" seamless="seamless" frameBorder="0"> </iframe>

---
background-image: url(../../../20171118/slides/day1/bostock-heer-groups.png)
background-size: contain
...
---
background-image: url(../../../20171118/slides/day1/bostock-heer-findings.png)
background-size: contain
...
---
background-image: url(../../../20171118/slides/day1/hierarchy.png)
background-size: contain
...
<iframe src="../../../20171118/slides/day1/03-heatmap.html" width="100%" height="550" scrolling="no" seamless="seamless" frameBorder="0"> </iframe>
...
```{r, code=readLines("../../../20171118/slides/day1/04-lines.R")}
```

<iframe src="../../../20171118/slides/day1/04-lines.html" width="100%" height="500" scrolling="no" seamless="seamless" frameBorder="0"> </iframe>

---
## Can improve a bit with interaction

```{r, code=readLines("../../../20171118/slides/day1/04-lines-b.R")}
```

<iframe src="../../../20171118/slides/day1/04-lines-b.html" width="100%" height="400" scrolling="no" seamless="seamless" frameBorder="0"> </iframe>
...
```{r, code=readLines("../../../20171118/slides/day1/06-rangeslider.R")}
```

<a href="../../../20171118/slides/day1/06-rangeslider.html" target="_blank">
 <div align="center">
   <img src="../../../20171118/slides/day1/svg.png" width="100%" />
 </div>
</a>
...
```{r, code=readLines("../../../20171118/slides/day1/07-webgl.R")}
```

<a href="../../../20171118/slides/day1/07-webgl.html" target="_blank">
 <div align="center">
   <img src="../../../20171118/slides/day1/webgl.png" width="100%" />
 </div>
</a>
...
* scattergl -- basically same as scatter (with [limitations](https://github.com/plotly/plotly.js/issues/130)), but [responsive with >1M points](../../../20171118/slides/day1/scattergl.R).
* pointcloud -- more restricted than scattergl, but [responsive w/ several million points](../../../20171118/slides/day1/pointcloud.R).
* heatmapgl -- [response with >1M cells](../../../20171118/slides/day1/heatmapgl.R) in heatmap.
...
```{r, code=readLines("../../../20171118/slides/day1/08-small-multiples.R")}
```

<iframe src="../../../20171118/slides/day1/08-small-multiples.html" width="100%" height="425" scrolling="no" seamless="seamless" frameBorder="0"> </iframe>

---
## Set selection mode and default selections

```{r, code=readLines("../../../20171118/slides/day1/08-modes.R")}
```

<iframe src="../../../20171118/slides/day1/08-modes.html" width="100%" height="425" scrolling="no" seamless="seamless" frameBorder="0"> </iframe>


---
## Make comparisons with dynamic brush

```{r, code=readLines("../../../20171118/slides/day1/08-dynamic.R")}
```

<iframe src="../../../20171118/slides/day1/08-dynamic.html" width="100%" height="500" scrolling="no" seamless="seamless" frameBorder="0"> </iframe>

---
## Customize the appearance of selections

```{r, code=readLines("../../../20171118/slides/day1/08-custom.R")}
```

<iframe src="../../../20171118/slides/day1/08-custom.html" width="100%" height="400" scrolling="no" seamless="seamless" frameBorder="0"> </iframe>

---
## Automate queries via animation

```{r, code=readLines("../../../20171118/slides/day1/08-automate.R")}
```

<iframe src="../../../20171118/slides/day1/08-automate.html" width="100%" height="400" scrolling="no" seamless="seamless" frameBorder="0"> </iframe>
...
#### Want something to do? Peruse the package demos `demo(package = "plotly")`! Any demo prefixed by 'sf' is for the newer mapping stuff
]
