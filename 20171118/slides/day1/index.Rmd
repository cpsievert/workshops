...
(3) In the R console, enter `browseURL("~/day1/index.html")`. If you see [this popup](popup.png), just press "Try Again".

(4) In the toolbar, go to Tools -> Global Options, then configure your pane layout [like this](panes.png).
...
* scattergl -- [most of the niceities](https://github.com/plotly/plotly.js/issues/130) of scatter, but [responsive with >1M points](scattergl.R).
...
Visit this post, replicate the example (no install needed), and use trelliscope to visualize `txhousing` (or, preferably, your own data!)
