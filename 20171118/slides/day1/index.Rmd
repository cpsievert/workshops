...
(1) Load plotly by entering `library(plotly)` in your R console.

(2) Now enter `plot_ly(x = c("A", "B"), y = 1:2)`. A message will print in the console. What is it?

(3) Now enter `plot_ly(x = 1:2, y = 1:2)`. What's different about the message/result?

(4) Now enter `schema()`. How many trace types do you see? What is a scatter mode?
...
# What is this object we've named `p`?
