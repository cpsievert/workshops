...
```r
withr::with_dir("~/day2/shiny/01", shiny::runApp(display.mode = "showcase"))
```
...
```r
withr::with_dir("~/day2/shiny/02", shiny::runApp(display.mode = "showcase"))
```
...
```r
withr::with_dir("~/day2/shiny/03", shiny::runApp(display.mode = "showcase"))
```
...
```r
withr::with_dir("~/day2/shiny/04", shiny::runApp(display.mode = "showcase"))
```
...
```r
withr::with_dir("~/day2/shiny/05", shiny::runApp(display.mode = "showcase"))
```
